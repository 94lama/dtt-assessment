...
<template>
    <button @click="store.toggleMode()" data-theme-toggle :class="store.mode === 'light' ? 'light' : 'dark'">
        <svg id="Layer_1" height="30" viewBox="0 0 24 24" width="30" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
