        ...
        <div class="navbar flex">
            ...
            <div v-else class="flex col-gap links around">
                ...
                <RouterLink :to="`/my-favourite-houses`" force="true">
                    <svg xmlns="http://www.w3.org/2000/svg" id="Filled" viewBox="0 0 24 24" width="30" height="30" :fill="router.currentRoute.value.path === '/my-favourite-houses' ? 'var(--primary)' : 'var(--tertiary-dark)'">
